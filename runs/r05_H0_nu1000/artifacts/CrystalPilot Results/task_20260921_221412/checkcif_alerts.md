# checkCIF alerts - 2026-09-21 22:54

target: publication:CrystalPilot Results/task_20260921_221412/final.cif
counts: A=9  B=1  C=23  G=22
delta vs job_20260921_224717_742909_09b1cc39: new [], resolved []
...
### 048_ALERT_1_C  MoietyFormula Not Given (or Incomplete) ........     Please Check
- meaning: Test MoietyFormula Given.
- remedy: 在CIF中_chemical_formula_moiety项给出残基分子式即可。
- explanation: (fill in: fixed, or the evidence-based justification for VALIDATION.md)
...
### 084_ALERT_3_C  High wR2 Value (i.e. > 0.25) ...................       0.26 Report
- meaning: wR2 偏高
- causes: 同 082；权重方案
- remedy: 同 082
- explanation: (fill in: fixed, or the evidence-based justification for VALIDATION.md)
...
### 260_ALERT_2_C  Large Average Ueq of Residue Including       Zr1      0.123 Check
- meaning: 某原子 Ueq 异常大
- causes: 鬼原子/部分占有/无序
...
### 342_ALERT_3_C  Low Bond Precision on  C-C Bonds ...............    0.01236 Ang.
...
### 905_ALERT_3_C  Negative K value in the Analysis of Variance ...    -28.082 Report
- meaning: Report Negative K values in the Analysis of Variance.
- remedy: 一般不会出现，有合理解释即可。 / 使用Shel 999 0.84删除高角度的点，如无法解决有合理解释即可。
- explanation: (fill in: fixed, or the evidence-based justification for VALIDATION.md)

### 905_ALERT_3_C  Negative K value in the Analysis of Variance ...     -4.560 Report
- meaning: Report Negative K values in the Analysis of Variance.
- remedy: 一般不会出现，有合理解释即可。 / 使用Shel 999 0.84删除高角度的点，如无法解决有合理解释即可。
- explanation: (fill in: fixed, or the evidence-based justification for VALIDATION.md)
...
### 934_ALERT_3_C  Number of (Iobs-Icalc)/Sigma(W) > 10 Outliers ..          1 Check
-3  8  0,
...
### 975_ALERT_2_C  Check Calcd Resid. Dens.  0.98Ang From O4      .       0.48 eA-3
...
## G notes (codes only)
002 x1, 004 x1, 009 x1, 045 x1, 092 x1, 174 x1, 176 x1, 187 x1, 191 x1, 606 x1, 794 x2, 802 x1, 860 x1, 869 x1, 910 x1, 913 x1, 969 x1, 978 x1, 984 x2, 985 x1
